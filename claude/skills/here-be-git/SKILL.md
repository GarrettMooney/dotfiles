...
> Your global rule is "only commit when I ask." Do you want THIS repo to override
> that and have the agent commit autonomously when it finishes a task?
...
This repo intentionally opts into autonomous commits, overriding the global
"only commit when I ask" default. In this repo specifically:

- Commit your changes when you complete a task or reach a logical stopping point
- Use clear, descriptive commit messages that explain what was done and why
- Leave the working directory clean (all changes committed) before ending your session
```
