...
brew "mas"  # Mac App Store CLI; add `mas "App", id: NNN` lines here if desired
# Tools previously installed via install.sh's package array (kept to avoid regression)
brew "git"
brew "neovim"
brew "ripgrep"
brew "eza"
...
uv "isort"
uv "jupyter-core"
uv "keyring", with: ["keyrings-google-artifactregistry-auth"]
uv "kfp"
uv "llm"
uv "marimo"
uv "maturin"
...
uv "modal"
uv "pip"
uv "pre-commit", with: ["pre-commit-uv"]
uv "prefect"
uv "ruff"
uv "sigil-sh"
uv "skedulord"
...
uv "ty"
uv "uvicorn"
uv "yt-dlp", with: ["mutagen", "yt-dlp-ejs"]
